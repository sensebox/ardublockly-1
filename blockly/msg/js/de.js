...
Blockly.Msg.sensebox_sd_filename = "Dateiname";
...
Blockly.Msg.senseBox_init_http_server_tip  = "Initialisiert den Server mit dem angegebenen Port.";
Blockly.Msg.senseBox_http_on_client_connect  = "Falls Client existiert:";
Blockly.Msg.senseBox_http_on_client_connect_tip  = "Überprüft ob ein Client verbunden ist und führt in diesem Fall die Anweisungen im Rumpf aus.";
Blockly.Msg.senseBox_http_method  = "Methode";
Blockly.Msg.senseBox_http_method_tip  = "Methode der aktuellen HTTP-Anfrage";
Blockly.Msg.senseBox_http_uri  = "URI";
Blockly.Msg.senseBox_http_uri_tip  = "URI der aktuellen HTTP-Anfrage";
Blockly.Msg.senseBox_http_user_agent  = "User-Agent";
Blockly.Msg.senseBox_http_user_agent_tip  = "Der User-Agent der aktuellen HTTP-Anfrage";
Blockly.Msg.senseBox_http_protocol_version  = "HTTP Version";
Blockly.Msg.senseBox_http_protocol_version_tip  = "Die HTTP Version der aktuellen HTTP-Anfrage";
Blockly.Msg.senseBox_http_success_tip  = "Sende eine erfolgreiche HTTP-Antwort.";
Blockly.Msg.senseBox_http_not_found_tip  = "Sende eine vorgefertigte 404 HTTP-Antwort.";
...
Blockly.Msg.senseBox_html_general_tag_tip  = "Ein allgemeiner HTML-Block";
Blockly.Msg.senseBox_html_document_tip = "Ein Block um ein HTML-Dokument zu erstellen";
Blockly.Msg.senseBox_tag_first_mutator_tip = "Erster Unterblock des Blockes";
Blockly.Msg.senseBox_tag_optional_mutator_tip = "Weiterer, optionaler Unterblock.";
// Cases
